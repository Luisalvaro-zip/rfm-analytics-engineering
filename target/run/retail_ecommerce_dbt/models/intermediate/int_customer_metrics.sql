    ...
    create or replace table `ga4-project-496021`.`ga4_data_intermediate`.`int_customer_metrics`
...
with staging_transactions as (
    select * from `ga4-project-496021`.`ga4_data_staging`.`stg_retail_transaction`
),
